		...
		<footer className={styles.footer}>
			<div className={`container ${styles.footerGrid}`}>
				...
				<div>
					...
					<ul>
						<li>
							<Link to={"feminino"} className={`${styles.linkMenu}`}>
								feminino
							</Link>
						</li>
						<li>
							<Link to={"masculino"} className={`${styles.linkMenu}`}>
								masculino
							</Link>
						</li>
						<li>
							<Link to={"oculos-de-grau"} className={`${styles.linkMenu}`}>
								óculos de grau
							</Link>
						</li>
						<li>
							<Link to={"oculos-de-sol"} className={`${styles.linkMenu}`}>
								óculos de sol
							</Link>
						</li>
						<li>
